...
export default {
	...
	"router": {
		...
		*/
		...
		// "username",
		// // #endif
		// "univerify","weixin", "apple"]
		"login": ["username", "smsCode", "univerify", "weixin", "apple"]
	},
	//关于应用
	"about": {
		//应用名称
		"appName": "uni-starter mu-piao",
		//应用logo
		"logo": "/static/logo.png",
		//公司名称
		...
		"agreements": [{
				...
				"url": "https://github.com/MuGuiLin/WebGL/blob/master/README.md" //对应的网络链接
			},
			{
				"title": "隐私政策", //如果开启了多语言国际化，本配置将失效。请在 lang/en.js 和 lang/zh-Hans.js中配置
				"url": "https://gitee.com/muguilin/WxEditor/edit/master/README.md" //对应的网络链接
			}
		],
		//应用的链接，用于分享到第三方平台和生成关于我们页的二维码
		"download": "http://www.muguilin.com",
		//version
		"version": "1.0.2" //用于非app端显示，app端自动获取
	},
